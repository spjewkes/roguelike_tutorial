...
_DEPS=actor.hpp ai.hpp attacker.hpp bsplistener.hpp destructible.hpp engine.hpp map.hpp
DEPS=$(patsubst %,$(SRC_DIR)/%,$(_DEPS))

_OBJ=actor.o ai.o attacker.o bsplistener.o destructible.o engine.o main.o map.o
